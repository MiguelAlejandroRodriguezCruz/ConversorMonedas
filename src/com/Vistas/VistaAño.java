...
public class VistaAño extends JFrame{
    ...
    public VistaAño() {
        ...
        iniciarComponentes();setIconImage(getIconImage());
    }
    @Override
    ...
    private void iniciarComponentes() {
        ...
        add(jcbSeleccionar);
        jcbSeleccionar.addItem("De Año a Decada");
        jcbSeleccionar.addItem("De Año a Siglo");
        jcbSeleccionar.addItem("De Decada a Año");
        jcbSeleccionar.addItem("De Decada a Siglo");
        jcbSeleccionar.addItem("De Siglo a Año");
        jcbSeleccionar.addItem("De Siglo a Decada");
    	...
    	jlbElije = new JLabelDiseño("Elije la unidad de tiempo a la que deseas convertir la actual");
    	jbtnOk = new JButtonGradient("OK");
        jbtnCancelar = new JButtonGradient("Cancel");
        
        panel.add(jlbElije);
        jlbElije.setBounds(15,20,500,20);
